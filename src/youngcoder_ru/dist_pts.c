...
Формат входных данных: На вход программы поступают четыре числа x1,y1,x2,y2x1​,y1​,x2​,y2​ — координаты двух точек на плоскости; вещественные числа.
Формат выходных данных: Одно число -- расстояние между точками (x1,y1)(x1​,y1​) и (x2,y2)(x2​,y2​). Точность — два знака после запятой.

Sample Input: 64.52 41.97 -77.86 -58.37
Sample Output: 174.18
*/
